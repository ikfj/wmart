...
public class UOrderManager {
  ...
  /**
   * userIDの注文管理クラスUOrderArrayを生成する．
   * @param userID ユーザーID
  ...
  /**
   * 引数で指定された注文を新たに作成する．
   * 成行注文の場合, 注文価格は0に設定される．
   * 通常, このUOrder.createOrderメソッドで新規注文を作成してから,
   * UOrder.addOrderメソッドを用いて注文を追加する．
   * @param userID ユーザーID
   * @param userName ユーザ名
   * @param brandName 銘柄名
  ...
  /**
   * 何人分のメンバーのUOrderArrayを管理しているか返す．
  ...
  /**
   * 管理しているUOrderArrayを列挙するためのEnumerationを返す．
