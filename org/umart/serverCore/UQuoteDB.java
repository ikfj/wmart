...
public class UQuoteDB {
  ...
  /**
   * 登録されているUTodaysQuoteオブジェクトの数を返す。
  ...
  /**
   * 当日分の情報を縮約してHistorical Quoteへ登録する。
   */
  public void update() {
  ...
  /**
   * 登録されているUHistoricalQuoteオブジェクトの数を返す。
  ...
  /**
   * index番目のUHistoricalQuoteオブジェクトを返す。
