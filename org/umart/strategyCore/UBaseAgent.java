package org.umart.strategyCore;
...
public class UBaseAgent {
   ...
   * このメソッドをオーバーライドする場合，必ず，最初にsuper.setParametersを呼ぶこと．
  ...
  /**
     ...
     @param maxDate 運用日数
     @param noOfBoardsPerDay 一日当たりの板寄せ回数
   */
  public void doActions(int date, int boardNo, int serverState,
